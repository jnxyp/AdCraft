...
def test_render_structured_prompt_contains_core_fields() -> None:
    ...
    assert "Keep AH and CTA especially short and punchy." in system_prompt
    ...
    assert "AH should be concise and high-impact" in user_prompt
    assert "CTA should be concise and action-oriented" in user_prompt
